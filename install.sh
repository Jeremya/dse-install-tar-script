...
mkdir -p dse-$VERSION/data/commitlog  dse-$VERSION/data/data  dse-$VERSION/data/hints  dse-$VERSION/data/saved_caches dse-$VERSION/spark/worker dse-$VERSION/spark/rdd  dse-$VERSION/log/spark/worker dse-$VERSION/log/spark/master dse-$VERSION/log/cassandra dse-$VERSION/data/dsefs dse-$VERSION/data/dsefs/data dse-$VERSION/resources/spark_rdd
